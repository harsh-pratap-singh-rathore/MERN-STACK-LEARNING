  ...
  return (
    <div className="bg-white block max-w-sm border border-gray-200 rounded-xl shadow-xs overflow-hidden">
      ...
      <div className="p-6 text-center">
        ...
        <a href="#">
          <h5 className="mt-3 mb-1 text-xl font-bold tracking-tight text-gray-900">
            {title}
          </h5>
        </a>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mt-4">
          <button 
            onClick={() => addtocart({ title, price, imgsrc })}
            className="inline-flex items-center text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-4 py-2 transition-colors cursor-pointer"
          >
            Add to Cart
